    ...
    render() {
        return (
            <div className="wrapper">
                ...
                ) : (this.state.currentGameTime === 0 &&
                      this.state.userDifficulty !== '') ||
                  this.state.index > 9 ? (
                    <div>
                        <Header
                            score={this.state.score}
                            currentTime={this.state.currentGameTime}
                        />
...
<<<<<<< HEAD
                        {this.state.index > 9 ? (
                            ...
                            >
                                ...
                                <path d="M35.76,11a1,1,0,0,1-1-1V3.5a1,1,0,0,1,2,0V10A1,1,0,0,1,35.76,11Z" />
                                <path d="M35.76,70.5a1,1,0,0,1-1-1V63a1,1,0,0,1,2,0v6.5A1,1,0,0,1,35.76,70.5Z" />
                                <path d="M68.75,37.5h-6.5a1,1,0,0,1,0-2h6.5a1,1,0,0,1,0,2Z" />
                                <path d="M9.26,37.5H2.76a1,1,0,1,1,0-2h6.5a1,1,0,0,1,0,2Z" />
                                <path d="M12.53,24.75a.94.94,0,0,1-.48-.13l-5.7-3.13a1,1,0,1,1,1-1.75L13,22.87a1,1,0,0,1,.4,1.36A1,1,0,0,1,12.53,24.75Z" />
                                <path d="M64.68,53.38a1,1,0,0,1-.48-.12l-5.7-3.13a1,1,0,0,1,1-1.76l5.69,3.13a1,1,0,0,1-.48,1.88Z" />
                                <path d="M48.51,14.27a1,1,0,0,1-.88-1.48l3.13-5.7a1,1,0,0,1,1.36-.39,1,1,0,0,1,.39,1.35l-3.12,5.7A1,1,0,0,1,48.51,14.27Z" />
                                <path d="M19.88,66.42a1.07,1.07,0,0,1-.49-.12A1,1,0,0,1,19,64.94l3.13-5.7a1,1,0,0,1,1.75,1l-3.13,5.7A1,1,0,0,1,19.88,66.42Z" />
                                <path d="M21.82,15a1,1,0,0,1-.85-.48L17.56,9a1,1,0,0,1,1.7-1.06l3.41,5.53a1,1,0,0,1-.32,1.38A1,1,0,0,1,21.82,15Z" />
                                <path d="M53.11,65.57a1,1,0,0,1-.85-.48l-3.42-5.53a1,1,0,0,1,1.7-1.05L54,64a1,1,0,0,1-.33,1.38A1,1,0,0,1,53.11,65.57Z" />
                                <path d="M58.3,23.56a1,1,0,0,1-.85-.47,1,1,0,0,1,.32-1.38L63.3,18.3a1,1,0,0,1,1.37.32A1,1,0,0,1,64.35,20l-5.53,3.42A1,1,0,0,1,58.3,23.56Z" />
                                <path d="M7.69,54.85A1,1,0,0,1,7.16,53l5.53-3.42a1,1,0,1,1,1.05,1.7L8.21,54.7A1,1,0,0,1,7.69,54.85Z" />
                            </svg>
                        ) : (
                            <svg
                                className="timerSVG"
                        ...
                        <div className="input-wrapper">
                            ...
                            <input
                                ...
                                required
                            />
                            <button onClick={this.handleSubmitScore}>
                                Submit Score
                            </button>
                        </div>
                        <Leaderboard />
...
>>>>>>> d7ac7f8ad7f18e78369f36e3aa477b4616b8fcc5
            </div>
        );
    }
}
